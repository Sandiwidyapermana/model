...
public class dashboardCustomerView extends cDashboardFrame{
  ...
  private cSidebarMenu menuBeliPulsa = new cSidebarMenu("Beli Telur", 70+50);
  private cSidebarMenu menuBeliPaket = new cSidebarMenu("Beli Vitamin", 70+50+50);
  private cSidebarMenu menuHistoryBeliPulsa = new cSidebarMenu("History Beli Telur", 70+50+50+50);
  private cSidebarMenu menuHistoryBeliPaket = new cSidebarMenu("History Beli Vitamin", 70+50+50+50+50);
  ...
  private cLabelInfo labelSisaPulsaBeranda = new cLabelInfo("Sisa Telur Anda", 25, 20);
  private cBigFont valueSisaPulsaBeranda = new cBigFont("10", 25, 60);
  private cLabelInfo labelSisaKuotaBeranda = new cLabelInfo("Sisa Vitamin Anda", 25, 150);
  private cBigFont valueSisaKuotaBeranda = new cBigFont("6", 25, 190);

  // Beli Pulsa components
  private cLabelInfo labelSisaPulsaBeliPulsa = new cLabelInfo("Sisa Telur Anda", 25, 20);
  private cBigFont valueSisaPulsaBeliPulsa = new cBigFont("10", 25, 60);
  private cLabelInfo labelPilihanBeliPulsa = new cLabelInfo("Pilihan Beli Telur", 25, 150);
  private cRadioButton rd5k = new cRadioButton("1kg", "25000", 25, 190, 72);
  private cRadioButton rd10k = new cRadioButton("5kg", "125000", 102, 190, 72);
  private cRadioButton rd25k = new cRadioButton("10kg", "250000", 179, 190, 72);
  private cRadioButton rd50k = new cRadioButton("15kg", "375000", 256, 190, 72);
  private cRadioButton rd100k = new cRadioButton("20kg", "500000", 333, 190, 72);
  private cBlueButton btnBeliPulsa = new cBlueButton("Beli Telur", 25, 220, 155);
  private ButtonGroup rdPilihaPulsa = new ButtonGroup();

  // beli paket components
  private cLabelInfo labelSisaKuotaBeliPaket = new cLabelInfo("Sisa Vitamin Anda", 25, 20);
  private cBigFont valueSisaKuotaBeliPaket = new cBigFont("6", 25, 60);
  private cLabelInfo labelPilihanBeliPaket = new cLabelInfo("Pilihan Beli Vitamin", 25, 150);
  private DefaultTableModel dmPaket;
  private cTable dataPaket;
  private cScrollPane spDataPaket;
  private cBlueButton btnBeliPaket = new cBlueButton("Beli Vitamin", 25, 390, 155);
  private cLabelInfo labelDeskripsiPaket = new cLabelInfo("Deskripsi vitamin", 473, 190);
  private cTextarea valueDeskripsiPaket = new cTextarea("", 473, 231, false);

  // history beli pulsa components
  private cLabelInfo labelHistoryPulsa = new cLabelInfo("Semua Pembelian Vitamin Saya", 25, 20);
  ...
  private cLabelInfo labelHistoryPaket = new cLabelInfo("Semua Pembelian Telur Saya", 25, 20);
  ...
  private void initsBeliPaket()
  {
    ...
    menuTitle.setText("Beli Vitamin");
    String[] dataUserHeader = {"Nama", "Vitamin", "Harga"};
    String[][] dataUser = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3"},
      {"Row2 Col1", "Row2 Col2", "Row2 Col3"},
      {"Salam Sehat", "1", "15.000"},
  ...
  private void initsHistoryBeliPulsa()
  {
    ...
    menuTitle.setText("Transaksi Vitamin Saya");
    String[] dataHistoryPulsaHeader = {"Vitamin", "Mitra", "Waktu", "Status"};
    String[][] dataHistoryPulsa = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3", "Row1 Col4"},
      {"25.000", "-", "2021-08-19 15:30:21", "diproses"},
      {"25.000", "Satwa Unggul", "2021-08-19 15:21:20", "selesai"},
  ...
  private void initsHistoryBeliPaket()
  {
    ...
    menuTitle.setText("Transaksi Vitamin Saya");
    String[] dataHistoryPaketHeader = {"Vitamin", "Jumlah", "Harga", "Waktu", "Status"};
    String[][] dataHistoryPaket = {
      {"Row1 Col1", "Row1 Col2", "Row1 Col3", "Row1 Col4", "Row1 Col5"},
      {"Ayam Sehat", "2", "76.000", "2021-08-19 15:21:20", "selesai"},
